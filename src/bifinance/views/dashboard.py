...
def render(app) -> None:
    ...
    app._lbl(scroll, f"{saudacao}! Bem-vindo ao BiFinance",
             size=14, weight="bold").grid(row=0, column=0, columnspan=4, sticky="w", pady=(0, 10))
    ...
    charts_frame.grid(row=2, column=0, columnspan=4, sticky="ew", pady=(0, 16))
    ...
    # ── CDI ───────────────────────────────────────────────────────────────────
    cdi_card = app._card(scroll, row=3, column=0, columnspan=4, sticky="ew", pady=(0, 16))
    ...
    # ── Transações recentes ───────────────────────────────────────────────────
    rec_card = app._card(scroll, row=4, column=0, columnspan=4, sticky="ew")
